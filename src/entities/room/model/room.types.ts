...
// NOTE: UI 표시를 위한 메타데이터 (별도 테이블 또는 계산된 값)
...
// NOTE: 상세 페이지 등에서 사용하는 전체 Room 정보 타입 (Composition 패턴)
export type RoomResponse = Room & RoomMetadata;
